from logic_engine import calculate_tradeup
...
def test_sampletradeup():
    ...
    assert calculate_tradeup(fillers1,anchor,t_min,t_max) == 0.0268774455824
    assert calculate_tradeup(fillers2,anchor,t_min,t_max) == 0.0429774455824
